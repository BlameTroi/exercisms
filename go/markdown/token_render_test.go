...
func Test_Token_Empty(t *testing.T) {

	assertRender(t, TokenRender, "", "<p></p>")

}

func Test_Token_Paragraph(t *testing.T) {
...
func Test_Token_Italics(t *testing.T) {
...
func Test_Token_Bold(t *testing.T) {
...
func Test_Token_Header(t *testing.T) {
	...
	input = "# this is an h1\n## this is an h2\n### this is an h3"
	want = "<h1>this is an h1</h1><h2>this is an h2</h2><h3>this is an h3</h3>"
	assertRender(t, TokenRender, input, want)
...
func Test_Token_Mixed(t *testing.T) {
